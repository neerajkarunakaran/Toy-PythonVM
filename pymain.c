...
main (int argc, char **argv)
{
  ...
  if ((mainstack =
       create_new_localstack (mainstack, codeobj[cnt].stacksize)) == NULL)
    {
...
*/
	...
	case CALL_FUNCTION:
	  ...
	  if ((mainstack =
	       create_new_localstack (mainstack,
				      codeobj[1].stacksize)) == NULL) 
	    {
...
CODEOBJECT *
create_new_codeobj (CODEOBJECT * codeobj)
{
  CODEOBJECT *new;
  if (codeobjcount == 0)
    {
